describe('To-one gmail and one zap user,CC-one gmail and one zap user', () => {
  it('passes', () => {
    ...
    //Message
    cy.get('.message-container > input').type("To-one gmail and one zap user,CC-one gmail and one zap user")
