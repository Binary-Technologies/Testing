describe('To-zap multiple,CC-zap multiple', () => {
  it('passes', () => {
    ...
    cy.get('.MultiEmail > input').type("test001")
    cy.get('.search-item').contains('test001@bixchat.xyz').click()
    cy.wait(3000)
    ...
    //Message
    cy.get('.message-container > input').type("To-zap multiple,CC-zap multiple")
