describe('To-one gmail and one zap user,CC-gmail multiple', () => {
  it('passes', () => {
    ...
    cy.wait(3000)
    cy.get('.sending-top-container-cc-left > :nth-child(2) > .MultiEmail > input').type("testuser70182@gmail.com").click()
    cy.wait(3000)
    

    //Message
    cy.get('.message-container > input').type("To-one gmail and one zap user,CC-gmail multiple")
