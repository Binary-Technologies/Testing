describe('To-gmail multiple,CC-gmail multiple', () => {
  it('passes', () => {
    ...
    cy.wait(3000)
    cy.get('.sending-top-container-cc-left > :nth-child(2) > .MultiEmail > input').type("kavigurbv@gmail.com").click()
    cy.wait(3000)
    

    //Message
    cy.get('.message-container > input').type("To-gmail multiple,CC-gmail multiple")
