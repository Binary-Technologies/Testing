describe('send new message_with one attachment_multiple receivers_external', () => {
  it('passes', () => {
    ...
    cy.get('.message-container > input').type("Send new message_with one attachment_multiple receivers_external")
