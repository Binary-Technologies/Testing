describe('send new message_with multiple attachments_one receiver_external', () => {
  it('passes', () => {
    ...
    cy.get('.message-container > input').type("Send new message_with multiple attachments_one receiver_external")
