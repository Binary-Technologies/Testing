describe('send new message_with one attachment_one receiver_external', () => {
  it('passes', () => {
    ...
    cy.get('.message-container > input').type("Send new message_with one attachment_one receiver_external")
