describe('send new message_only text_multiple receivers_internal', () => {
  it('passes', () => {
    ...
    cy.get('.message-container > input').type("Send new message_only text_multiple receivers_internal")
