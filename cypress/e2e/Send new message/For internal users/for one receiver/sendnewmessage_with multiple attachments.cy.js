describe('send new message_with multiple attachments_one receiver_internal', () => {
  it('passes', () => {
    ...
    cy.get('.message-container > input').type("Send new message_with multiple attachments_one receiver_internal")
